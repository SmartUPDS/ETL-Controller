...
public class KhiIngester implements Ingester{
    ...
    public void ingestResources() throws ETLGenericException {
        ...
        log.info("FINISH: Transform artworks from KHI in "+Timer.reportHumanFriendly("com.smartupds.etlcontroller.etl.controller.impl.khi.khiingester.ingest.artworks"));
        ...
        log.info("FINISH: Transform artworks from KHI in "+Timer.reportHumanFriendly("com.smartupds.etlcontroller.etl.controller.impl.khi.khiingester.ingest.artworkslvl2"));
        ...
        log.info("FINISH: Transform artworks from KHI in "+Timer.reportHumanFriendly("com.smartupds.etlcontroller.etl.controller.impl.khi.khiingester.ingest.artworkslvl3"));            
        ...
        log.info("FINISH: Transform artworks from KHI in "+Timer.reportHumanFriendly("com.smartupds.etlcontroller.etl.controller.impl.khi.khiingester.ingest.artworkslvl4"));
        ...
        log.info("FINISH: Transform Builtworks from KHI in "+Timer.reportHumanFriendly("com.smartupds.etlcontroller.etl.controller.impl.khi.khiingester.ingest.builtworks"));
        ...
        log.info("FINISH: Transform Builtworks from KHI in "+Timer.reportHumanFriendly("com.smartupds.etlcontroller.etl.controller.impl.khi.khiingester.ingest.builtworkslvl2"));
        ...
        log.info("FINISH: Transform Builtworks from KHI in "+Timer.reportHumanFriendly("com.smartupds.etlcontroller.etl.controller.impl.khi.khiingester.ingest.builtworkslvl3"));
        ...
        log.info("FINISH: Transform Builtworks from KHI in "+Timer.reportHumanFriendly("com.smartupds.etlcontroller.etl.controller.impl.khi.khiingester.ingest.builtworkslvl4"));
        ...
        log.info("FINISH: Transform photographs from KHI in "+Timer.reportHumanFriendly("com.smartupds.etlcontroller.etl.controller.impl.khi.khiingester.ingest.photographs"));
        ...
        log.info("FINISH: Transform Builtworks from KHI in "+Timer.reportHumanFriendly("com.smartupds.etlcontroller.etl.controller.impl.khi.khiingester.ingest.actors"));
        ...
        log.info("FINISH: Transform photographs using FCs FRs from KHI in "+Timer.reportHumanFriendly("com.smartupds.etlcontroller.etl.controller.impl.khi.khiingester.ingest.photographs-fc-fr"));
        ...
        log.info("FINISH: Transform Works using FCs FRs from KHI in "+Timer.reportHumanFriendly("com.smartupds.etlcontroller.etl.controller.impl.khi.khiingester.ingest.works-fc-fr"));
    }
