...
public class ItattiHomogenizer implements Homogenizer{
    ...
    private void consolidateN3Resources() throws IOException{
        ...
        Utils.consolidateN3Resources(new File(Resources.FOLDER_OUTPUT_TRANSFORMED_VILLA_I_TATTI_FOTOINDEX_FC_FR), new File(Resources.FOLDER_OUTPUT_NORMALIZED_VILLA_I_TATTI_FOTOINDEX_FC_FR), Resources.FOTOINDEX, Resources.MAX_FILESIZE_OUTPUT_N3_RESOURCES_IN_MB, Resources.EXTENSION_N3);
