...
public class Resources {
    ...
    public static final String FOLDER_INPUT_NORMALIZED_ZERI_ARTWORKS=FOLDER_INPUT_NORMALIZED_ZERI+"/"+"artworks";
    public static final String FOLDER_INPUT_NORMALIZED_ZERI_PHOTOGRAPHS=FOLDER_INPUT_NORMALIZED_ZERI+"/"+"photographs";
    ...
    public static final String FOLDER_OUTPUT_TRANSFORMED_ZERI_ARTWORKS=FOLDER_OUTPUT_TRANSFORMED_ZERI+"/"+"artworks";
    public static final String FOLDER_OUTPUT_TRANSFORMED_ZERI_PHOTOGRAPHS=FOLDER_OUTPUT_TRANSFORMED_ZERI+"/"+"photographs";
    ...
    /* ZERI resources */
    public static final String ZERI_ARTWORKS_ZIP_FILENAME="artworks.zip";
    public static final String ZERI_PHOTOGRAPHS_ZIP_FILENAME="photographs.zip";
