...
public class VocsIngester implements Ingester {
    ...
    public void ingestResources() throws ETLGenericException {
        ...
        for(File file: FileUtils.listFiles(new File(Resources.FOLDER_OUTPUT_NORMALIZED_MIDAS_VOCS), null, true)){
            Utils.uploadFile(this.triplestoreConnection, file, Resources.GRAPHSPACE_MIDAS_VOCS, false);
        }
